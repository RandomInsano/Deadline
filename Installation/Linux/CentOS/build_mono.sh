...
curl -L http://download.mono-project.com/sources/mono/mono-2.10.2.tar.bz2 | tar jx
cd mono*
...
curl -L http://download.mono-project.com/sources/libgdiplus/libgdiplus-2.10.9.tar.bz2 | tar jx
cd libgdi*
